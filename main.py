...
class Wordle:
    ...
    def make_guess(self):
        ...
        charPosCounts = self.gen_char_position_count()
        ...
        for word in self.allWords:
            ...
            # check position score after frequency score
            ...
            elif frequencyScore == maxFrequencyScore:
    ...
    def gen_char_position_count(self):
        position_counts = [{}, {}, {}, {}, {}]
        
        for word in self.filteredWords:
            for i, char in enumerate(word):
                if char not in position_counts[i]:
